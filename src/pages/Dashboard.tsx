    ...
    <div className="space-y-6">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          <Link to="/transactions" className="group flex flex-col items-center justify-center gap-4 p-8 bg-card hover:bg-primary/5 text-muted-foreground hover:text-primary rounded-xl border border-border hover:border-primary/20 transition-all hover:-translate-y-1 hover:shadow-md">
            <div className="p-4 bg-primary/10 text-primary rounded-full group-hover:scale-110 group-hover:bg-primary group-hover:text-primary-foreground transition-all">
              <PlusCircle className="h-8 w-8" />
            </div>
            <span className="font-semibold text-base lg:text-lg">New Transaction</span>
          </Link>
          <Link to="/customers" className="group flex flex-col items-center justify-center gap-4 p-8 bg-card hover:bg-purple-500/5 text-muted-foreground hover:text-purple-600 rounded-xl border border-border hover:border-purple-500/20 transition-all hover:-translate-y-1 hover:shadow-md">
            <div className="p-4 bg-purple-500/10 text-purple-600 rounded-full group-hover:scale-110 group-hover:bg-purple-600 group-hover:text-white transition-all">
              <Car className="h-8 w-8" />
            </div>
            <span className="font-semibold text-base lg:text-lg">Add Customer</span>
          </Link>
          <Link to="/billing" className="group flex flex-col items-center justify-center gap-4 p-8 bg-card hover:bg-emerald-500/5 text-muted-foreground hover:text-emerald-600 rounded-xl border border-border hover:border-emerald-500/20 transition-all hover:-translate-y-1 hover:shadow-md">
            <div className="p-4 bg-emerald-500/10 text-emerald-600 rounded-full group-hover:scale-110 group-hover:bg-emerald-600 group-hover:text-white transition-all">
              <CreditCard className="h-8 w-8" />
            </div>
            <span className="font-semibold text-base lg:text-lg">Process Payment</span>
          </Link>
          <Link to="/employees" className="group flex flex-col items-center justify-center gap-4 p-8 bg-card hover:bg-orange-500/5 text-muted-foreground hover:text-orange-600 rounded-xl border border-border hover:border-orange-500/20 transition-all hover:-translate-y-1 hover:shadow-md">
            <div className="p-4 bg-orange-500/10 text-orange-600 rounded-full group-hover:scale-110 group-hover:bg-orange-600 group-hover:text-white transition-all">
              <Clock className="h-8 w-8" />
            </div>
            <span className="font-semibold text-base lg:text-lg text-center">Employee Time In/Out</span>
          </Link>
        </div>
      </div>
    </div>
